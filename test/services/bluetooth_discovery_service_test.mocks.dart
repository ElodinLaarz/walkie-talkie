...
// in walkie_talkie/test/services/bluetooth_discovery_service_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAdvertisementData extends _i1.Mock implements _i3.AdvertisementData {
  ...
  bool get connectable =>
      (super.noSuchMethod(Invocation.getter(#connectable), returnValue: false)
          as bool);
  ...
  @override
  Map<_i2.Guid, List<int>> get serviceData =>
      (super.noSuchMethod(
  ...
  @override
  List<_i2.Guid> get serviceUuids =>
      (super.noSuchMethod(
  ...
  List<List<int>> get msd =>
      (super.noSuchMethod(Invocation.getter(#msd), returnValue: <List<int>>[])
          as List<List<int>>);
